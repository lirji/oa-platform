...
/**
 * 通知长连探针。单文件程序，{@code java WsProbe.java <url> <userId> <期望消息数> <超时秒>}，无需构建。
 *
...
public class WsProbe {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String userId = args.length > 1 ? args[1] : "seed-user-1";
        ...
        WebSocket ws = HttpClient.newHttpClient().newWebSocketBuilder()
                .buildAsync(URI.create(url + "?userId=" + userId), new WebSocket.Listener() {
                    @Override
